...
# Caminho do áudio a analisar
parser = argparse.ArgumentParser(
    description="Pipeline de reconhecimento automático de fala (ASR)."
)
parser.add_argument("--input", required=True, help="Arquivo de áudio a analisar")
audio_path = parser.parse_args().input
